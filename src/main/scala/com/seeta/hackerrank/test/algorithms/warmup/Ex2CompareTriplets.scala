...
/**
  ...
  *
  * We define the rating for Alice's challenge to be the triplet (a0, a1, a2), and the rating for
  * Bob's challenge to be the triplet (b0, b1, b2).
  *
  ...
  *
  *  ==Input Format==
  *  The first line contains 3 space-separated integers, describing the respective values in triplet A.
  *  The second line contains 3 space-separated integers, describing the respective values in triplet B.
  *
  *  {{{
  *    5 6 7
  *    3 6 10
